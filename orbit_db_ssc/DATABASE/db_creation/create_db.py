...
# This script creates a new database in PostgreSQL. 
# It runs via the creation_main.py script.
...
def create_database():
    ...
    try:
        ...
        cursor.execute("CREATE DATABASE orbital_db") ################################## NAME OF THE DATABASE
...
# this script didn't work so the creation of tables for the database is in a separate script.
