...
# THis scriot is good but it still over wrote the old data whne new where fetcehd... 
...
LOG_FILE = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'populate2.log')
