...
given two columns with id and norad id next to eachother. 
SELECT gp_id, NORAD_CAT_ID
FROM gp
ORDER BY gp_id DESC, NORAD_CAT_ID;


SELECT COUNT(DISTINCT NORAD_CAT_ID) AS unique_count
FROM gp;
