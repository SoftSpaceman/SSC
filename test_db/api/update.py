...
config_api.read(r'C:\Users\Bananberg\Desktop\Space_info\SSC\projects\SSC_database\test_db\api\APIconfig.ini')



config_db = configparser.ConfigParser()
config_db.read(r'C:\Users\Bananberg\Desktop\Space_info\SSC\projects\SSC_database\test_db\database\database_config.ini') # consider chaging theses to a relative path... to smoothen the transition to a new computer.




siteCred = {'identity': config_api.get("configuration", "username"), 'password': config_api.get("configuration", "password")}
...
def fetch_data_from_api(session):
    ...
    try:
        ...
        logging.error("Error fetching data from API:", e)  # Log any exceptions that occur during API requests
        return None
