...
def populate():
    ...
    try:
        ...
        z = f'/class/gp/creation_date/%3Enow-0.0034722/orderby/norad_cat_id/format/json' ######### 0.0034722 days = data from now and 5 minuts back. TRY IT OUT!
        ...
        b = f'/class/gp/CREATION_DATE/%3Enow-10/orderby/CREATION_DATE%20asc/format/json'
        ...
        fetched_data = fetch_satellite_data(session, uriBase, requestCmdAction, b) ######## Insertion query here.
                                                                                #    
